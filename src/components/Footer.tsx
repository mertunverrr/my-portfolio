  ...
  return (
    <footer className="h-full bg-titleDarkColor">
      <div className="flex flex-col items-center p-6 space-y-2">
        <h1 className="text-containerColor text-3xl font-medium tracking-wide">
          Mert Ünver
        </h1>
        <div className="text-bodyColor space-x-6 text-lg">
        ...
        <span className="text-sm pt-6">© mertunverrr. All rights reserved</span>
      </div>
    </footer>
  );
}
