function Skills() {
  return (
    <section className="container flex flex-col h-screen justify-center">
      ...
      <div className="flex flex-row space-x-12">
        <div className="basis-1/2 bg-containerColor flex flex-col py-10 px-12 rounded-md drop-shadow-sm">
          ...
          <div className="grid grid-cols-6 gap-y-4 mt-10">
            ...
            <div className="flex space-x-2 col-start-5 col-end-7">
              <i className="bx bxs-badge-check text-titleColor text-xl"></i>
              <div>
                <h3 className="text-titleColor text-xl font-medium">Git</h3>
                <span className="text-sm">Intermediate</span>
              </div>
            </div>
          </div>
